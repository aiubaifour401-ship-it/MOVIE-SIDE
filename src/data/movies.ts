...
export const SAMPLE_MOVIES: Movie[] = [
  ...
  {
    id: 'icc-cricket-wc-2026',
    title: 'ICC T20 World Cup Final 2026 Live',
    tagline: 'The Ultimate Cricket Clash Live in Ultra 4K 60FPS!',
    synopsis: 'Live broadcast from Mirpur National Cricket Stadium. Watch Bangladesh vs India in the Grand Final of the T20 World Cup 2026 with multi-cam, ultra-low latency spatial audio, and real-time live commentary.',
    posterUrl: 'https://images.unsplash.com/photo-1540747913346-19e32dc3e97e?q=80&w=1000&auto=format&fit=crop',
    backdropUrl: 'https://images.unsplash.com/photo-1531415074968-036ba1b575da?q=80&w=1600&auto=format&fit=crop',
    trailerYoutubeId: 'Way9Dexny3w',
    releaseYear: 2026,
    imdbRating: 9.8,
    rottenTomatoesScore: 99,
    runtimeMinutes: 210,
    director: 'ICC Live Production',
    genres: ['Sports', 'Action'],
    contentRating: 'G',
    featured: true,
    trending: true,
    isSports: true,
    sportsLeague: 'ICC World Cup',
    liveStatus: 'LIVE',
    language: 'English / Bengali',
    cast: [
      { id: 'cs1', name: 'Shakib Al Hasan', role: 'Captain', avatarUrl: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&auto=format&fit=crop' },
      { id: 'cs2', name: 'Rohit Sharma', role: 'Captain', avatarUrl: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=200&auto=format&fit=crop' }
    ],
    reviews: []
  },
  {
    id: 'uefa-champions-league-2026',
    title: 'UEFA Champions League Final 2026',
    tagline: 'European Football Crown Championship Final',
    synopsis: 'Real Madrid vs Manchester City live from Allianz Arena Munich. Streamed in 4K HDR10+ with tactical multi-angle cameras and Dolby Atmos Stadium Sound.',
    posterUrl: 'https://images.unsplash.com/photo-1508098682722-e99c43a406b2?q=80&w=1000&auto=format&fit=crop',
    backdropUrl: 'https://images.unsplash.com/photo-1518091043644-c1d4457512c6?q=80&w=1600&auto=format&fit=crop',
    trailerYoutubeId: 'Way9Dexny3w',
    releaseYear: 2026,
    imdbRating: 9.6,
    rottenTomatoesScore: 97,
    runtimeMinutes: 120,
    director: 'UEFA Broadcast Euro',
    genres: ['Sports', 'Action'],
    contentRating: 'G',
    featured: true,
    trending: true,
  ...
  {
    id: 'f1-monaco-grand-prix',
    title: 'Formula 1 Monaco Grand Prix 2026',
    tagline: 'High Octane Racing in the Streets of Monte Carlo',
    synopsis: 'Experience the world’s most prestigious motorsport race with driver onboard telemetry cameras, live pit stop analytics, and immersive 60fps streaming.',
    posterUrl: 'https://images.unsplash.com/photo-1568605117036-5fe5e7bab0b7?q=80&w=1000&auto=format&fit=crop',
    ...
    rottenTomatoesScore: 95,
    runtimeMinutes: 150,
    director: 'F1 Media Operations',
    genres: ['Sports', 'Action'],
    contentRating: 'G',
    trending: true,
    isSports: true,
    sportsLeague: 'Formula 1',
    liveStatus: 'UPCOMING',
    language: 'English',
    cast: [],
    reviews: []
  ...
  {
    id: 'ufc-310-championship',
    title: 'UFC 310: Main Event Championship Night',
    tagline: 'Octagon War for the World Heavyweight Title',
    synopsis: 'Live UFC World Championship bout featuring top pound-for-pound fighters. Includes slow-motion replays and corner audio feeds.',
    posterUrl: 'https://images.unsplash.com/photo-1517649763962-0c623266ddc0?q=80&w=1000&auto=format&fit=crop',
    backdropUrl: 'https://images.unsplash.com/photo-1517838277536-f5f99be501cd?q=80&w=1600&auto=format&fit=crop',
    trailerYoutubeId: 'Way9Dexny3w',
    releaseYear: 2026,
    imdbRating: 9.2,
    rottenTomatoesScore: 91,
    runtimeMinutes: 180,
    director: 'UFC Live Pay-Per-View',
    genres: ['Sports', 'Action', 'Thriller'],
    contentRating: 'TV-MA',
    trending: true,
    isSports: true,
    sportsLeague: 'UFC',
    liveStatus: 'HIGHLIGHTS',
    language: 'English',
    cast: [],
    reviews: []
  }
